        ...
        <tbody>
          {benefits.map((row) => (
            <tr key={row.benefit} className="border border-gray-200 hover:bg-gray-50">
              ...
              <td className={`p-2.5 text-center font-medium border border-gray-200 ${row.f === "100%" || row.f === "80%" ? "text-[#00353E]" : "text-amber-600"} ${highlighted === "Plan F" ? "bg-[#E6F7F9]" : ""}`}>{row.f}</td>
              <td className={`p-2.5 text-center font-medium border border-gray-200 ${row.g === "100%" || row.g === "80%" ? "text-[#00353E]" : "text-amber-600"} ${highlighted === "Plan G" ? "bg-[#E6F7F9]" : ""}`}>{row.g}</td>
              <td className={`p-2.5 text-center font-medium border border-gray-200 ${row.n === "100%" || row.n === "80%" ? "text-[#00353E]" : "text-amber-600"} ${highlighted === "Plan N" ? "bg-[#E6F7F9]" : ""}`}>{row.n}</td>
            </tr>
          ))}
        </tbody>
      </table>
...
export function MedigapPlanF() {
  return (
    <InfoPage section={SECTION} sectionHref={SECTION_HREF} title="Medigap Plan F" accentColor={ACCENT}
      ...
      <div className="bg-[#E6F7F9] border border-blue-100 rounded-xl p-4 text-sm text-blue-800 mb-6">
          ...
          <tbody>
            {[
              ...
              <tr key={row.feature} className="border border-gray-200 hover:bg-gray-50">
                ...
                <td className="p-3 text-center font-medium text-blue-700 bg-[#E6F7F9]">{row.n}</td>
              </tr>
            ))}
          </tbody>
        </table>
  ...
  return (
    <InfoPage section={SECTION} sectionHref={SECTION_HREF} title="Compare Supplement Plans" accentColor={ACCENT}
          ...
          <tbody>
            {[
              ...
              <tr key={row.factor} className="border border-gray-200 hover:bg-gray-50">
                ...
                <td className="p-3 text-center text-blue-700 font-medium text-xs bg-[#E6F7F9]">{row.g}</td>
      ...
      <div className="grid sm:grid-cols-2 gap-4 mb-6">
        <div className="bg-[#E6F7F9] border border-blue-100 rounded-xl p-4">
