  ...
  return (
    ...
    >
      ...
      <div style={{ background: 'rgba(255,255,255,0.08)', padding: '8px 20px', display: 'flex', alignItems: 'center', gap: '8px', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
        ...
        <span style={{ color: '#fff', fontSize: '11px', fontWeight: 600, letterSpacing: '0.04em', textTransform: 'uppercase', fontFamily: "'Montserrat', sans-serif" }}>
          AI Recommended Plan
        </span>
        <span style={{ color: 'rgba(255,255,255,0.4)', fontSize: '11px', marginLeft: 'auto', fontFamily: "'Montserrat', sans-serif" }}>
      ...
      <div style={{ padding: '20px', display: 'flex', gap: '20px', alignItems: 'flex-start' }}>
        ...
        <div style={{ width: '56px', height: '56px', borderRadius: '14px', background: 'rgba(255,255,255,0.12)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, border: '1px solid rgba(255,255,255,0.1)' }}>
          <span style={{ color: 'white', fontWeight: 700, fontSize: '16px', fontFamily: "'Montserrat', sans-serif" }}>{carrierInitials}</span>
        </div>

        {/* Plan info */}
        <div style={{ flex: 1 }}>
          <div style={{ color: 'rgba(255,255,255,0.6)', fontSize: '11px', fontWeight: 600, fontFamily: "'Montserrat', sans-serif", marginBottom: '2px' }}>{plan.carrier}</div>
          <div style={{ color: 'white', fontSize: '16px', fontWeight: 700, fontFamily: "'Montserrat', sans-serif", marginBottom: '8px' }}>{plan.planName}</div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '2px', marginBottom: '10px' }}>
            ...
            <span style={{ color: 'rgba(255,255,255,0.7)', fontSize: '11px', marginLeft: '6px', fontFamily: "'Montserrat', sans-serif" }}>&nbsp;{stars} CMS Stars</span>
            <span style={{ color: 'rgba(255,255,255,0.4)', fontSize: '11px', marginLeft: '8px', fontFamily: "'Montserrat', sans-serif" }}>&nbsp;{plan.planType}</span>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '4px', marginBottom: '16px' }}>
            {score.reasons.map((reason, i) => (
              <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                ...
                <span style={{ color: 'rgba(255,255,255,0.85)', fontSize: '12px', fontFamily: "'Montserrat', sans-serif" }}>{reason}</span>
              </div>
            ))}
          </div>
          ...
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', marginBottom: '16px' }}>
            {[
              ...
              <div key={label} style={{ background: 'rgba(255,255,255,0.08)', borderRadius: '10px', padding: '10px 14px', minWidth: '120px' }}>
                <div style={{ color: 'white', fontSize: '16px', fontWeight: 700, fontFamily: "'Montserrat', sans-serif" }}>{value}</div>
                <div style={{ color: 'rgba(255,255,255,0.5)', fontSize: '10px', fontWeight: 600, fontFamily: "'Montserrat', sans-serif", marginTop: '2px' }}>{label}</div>
              </div>
            ))}
          </div>
          ...
          <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
            {onViewPlan && (
              <button onClick={onViewPlan} style={{ background: 'rgba(255,255,255,0.95)', color: '#00353E', border: 'none', borderRadius: '8px', padding: '10px 20px', fontWeight: 700, fontSize: '13px', fontFamily: "'Montserrat', sans-serif", cursor: 'pointer' }}>
                View Plan
              </button>
            )}
            <button
              onClick={() => setExpanded(!expanded)}
              style={{ background: 'rgba(255,255,255,0.1)', color: 'rgba(255,255,255,0.8)', border: '1px solid rgba(255,255,255,0.2)', borderRadius: '8px', padding: '10px 16px', fontWeight: 600, fontSize: '12px', fontFamily: "'Montserrat', sans-serif", cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '6px', justifyContent: 'center' }}
            >
          ...
          {expanded && (
            <div style={{ marginTop: '16px', background: 'rgba(11,27,36,0.25)', borderRadius: '10px', padding: '16px', border: '1px solid rgba(255,255,255,0.08)' }}>
              <div style={{ color: 'rgba(255,255,255,0.6)', fontSize: '11px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.04em', marginBottom: '12px', fontFamily: "'Montserrat', sans-serif" }}>
                ...
                return (
                  <div key={b.factor} style={{ marginBottom: '10px' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '4px' }}>
                      <span style={{ color: 'rgba(255,255,255,0.8)', fontSize: '12px', fontFamily: "'Montserrat', sans-serif" }}>{b.factor}</span>
                      <span style={{ color: 'rgba(255,255,255,0.5)', fontSize: '11px', fontFamily: "'Montserrat', sans-serif" }}>{b.weight}% weight</span>
                    </div>
              ...
              <div style={{ marginTop: '12px', padding: '10px', background: 'rgba(255,255,255,0.04)', borderRadius: '8px', display: 'flex', alignItems: 'flex-start', gap: '8px' }}>
                ...
                <span style={{ color: 'rgba(255,255,255,0.4)', fontSize: '11px', lineHeight: '1.5', fontFamily: "'Montserrat', sans-serif" }}>
              ...
              {sources.length > 0 && (
                <div style={{ marginTop: '10px', color: 'rgba(255,255,255,0.3)', fontSize: '10px', fontFamily: "'Montserrat', sans-serif" }}>
